<template>
  <v-app>
      ...
      >
        <template v-slot:activator="{ on, attrs }">
          <v-btn
            ...
            class="mr-1"
          >
            <v-avatar color="error" :size="avatarSize">
    ...
    <v-navigation-drawer
      ...
      :width="barSize"
    >
      <v-row align="center" justify="center" class="my-5" dense>
        <v-col cols="auto" class="text-center">
          <v-img
            ...
            class="mx-auto"
          ></v-img>
          <div class="white--text font-weight-bold mt-2" style="font-size: 11px; text-transform: uppercase;" v-if="!drawer">
            MUNICIPALIDAD DE<br>LA VICTORIA
          </div>
        </v-col>
      </v-row>
      <v-divider></v-divider>
